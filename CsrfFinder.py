    ...
    if form == "2" :
        ...
        if token == None:
	        ...
	        if token1 == None:
		        ...
		        if token2 == None:
				    token3 = input2.find ("input",{"name":"csrfmiddlewaretoken"})
				    if token3 == None:
					    token4 = input2.find ("input", {"name":"fb_dtsg"})
					    if token4 == None:
    ...
    if form == "3" :
        ...
        if token == None:
	        ...
	        if token1 == None:
		        ...
		        if token2 == None:
				    token3 = input3.find ("input",{"name":"csrfmiddlewaretoken"})
				    if token3 == None:
					    token4 = input3.find ("input", {"name":"fb_dtsg"})
					    if token4 == None:
    ...
    if form == "4" :
        ...
        if token == None:
	        ...
	        if token1 == None:
		        ...
		        if token2 == None:
				    token3 = input4.find ("input",{"name":"csrfmiddlewaretoken"})
				    if token3 == None:
					    token4 = input4.find ("input", {"name":"fb_dtsg"})
					    if token4 == None:
    ...
    if form == "5" :
        ...
        if token == None:
	        ...
	        if token1 == None:
		        ...
		        if token2 == None:
				    token3 = input5.find ("input",{"name":"csrfmiddlewaretoken"})
				    if token3 == None:
					    token4 = input5.find ("input", {"name":"fb_dtsg"})
					    if token4 == None:
